...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "hzDycNEh1Ph6ACUYK2TzkrH63";       // Change this
	public static final String REST_CONSUMER_SECRET = "90vvpuNaArEqSWBsbp1Ski9MoFpruBNrDYiNmh1JXv0tmnLizP"; // Change this
	public static final String REST_CALLBACK_URL = "oauth://julioTweet"; // Change this (here and in manifest)
